...
| agent.yaml | ✅ | 2026-03-31 | 초급~중급 타겟, 에버그린 60%/트렌딩 40% |
| 시드 키워드 | ✅ | 2026-03-31 | 60개 키워드, 8 카테고리 |
| 키워드 리서치 | ✅ | 2026-03-31 | P0 20개 선정 완료 |
| 초기 시딩 (10편) | ✅ | 2026-03-31 | AI 5 + Cloud 3 + DevTool 2 |
| Docsify 구조 생성 | ✅ | 2026-03-31 | index.html, styles, sidebar, sitemap |
| Vercel 프로젝트 생성 | ⬜ | - | Root Dir: sites/tech/docs |
| 스케줄 등록 | ⬜ | - | |
| 런칭 | ⬜ | - | |
| Search Console 등록 | ⬜ | - | |
...
| 항목 | 상태 | 날짜 | 비고 |
|------|------|------|------|
| 도메인 선정 | ✅ | - | 건강식품, 습관, 스트레칭, 운동 |
| config.yaml | ✅ | - | 도메인/URL 미설정 |
| agent.yaml | ✅ | 2026-03-31 | 초급 타겟, 에버그린 70%/트렌딩 30% |
| 시드 키워드 | ✅ | 2026-03-31 | 50개 키워드, 8 카테고리 |
| 키워드 리서치 | ✅ | 2026-03-31 | P0 20개 선정 완료 |
| 초기 시딩 (10편) | ✅ | 2026-03-31 | 스트레칭 3 + 식품 3 + 운동 2 + 습관 1 + 미신파괴 1 |
| Docsify 구조 생성 | ✅ | 2026-03-31 | index.html, styles, sidebar, sitemap |
| Vercel 프로젝트 생성 | ⬜ | - | Root Dir: sites/health/docs |
| 스케줄 등록 | ⬜ | - | |
| 런칭 | ⬜ | - | |
